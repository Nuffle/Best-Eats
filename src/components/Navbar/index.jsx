  ...
  return (
    <div className='max-w-7xl mx-auto flex justify-between items-center p-4'>
      ...
      <button className='bg-black text-white md:flex items-center py-2 rounded-full'>
        <BsFillCartFill size={20} className='mr-2'/> <span className='hidden md:flex'>Carrinho</span>
      </button>
      ...
      <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'}>
        ...
        <h2 className='text-2xl p-4 select-none'>
          Best <span className='font-bold'>Eats</span>
        </h2>
        <nav>
          <ul className='flex flex-col p-4 text-gray-800'>
            ...
            <li className='text-xl py-4 flex'><BsFillSaveFill size={25} className='mr-4'/> O melhor</li>
            <li className='text-xl py-4 flex'><FaUserFriends size={25} className='mr-4'/> Convidar amigos</li>
          </ul>
        </nav>
      </div>
    </div>
